...
import { getModuleRouter } from './utils/router'
...
export default class App {
  static run(config: any): BootStrapModule {
    ...
    return {
      bootstrapModule(module: Constructor): Promise<any> {
        const _routes = getModuleRouter(module)
        
        console.log(JSON.stringify(_routes))
